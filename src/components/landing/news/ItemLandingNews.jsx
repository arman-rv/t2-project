const ItemLandingNews = ({ element }) => {
  return (
    <>
      <div
        dir="rtl"
        className="dark:bg-gradient-to-l from-[#182239] to-[#314062] w-[95%] h-[120px] px-5 rounded-xl shadow-[0_-5px_5px_#dddf] bg-white dark:shadow-[0_-5px_5px_#2e2e49] max-[600px]:my-2 flex flex-row-reverse justify-around items-center max-[1400px]:[&>p]:text-[18px] max-[600px]:flex-col-reverse max-[600px]:h-[145px]"
      >
