...
const HeroSection = () => {
  ...
  return (
    <div
      className="w-full h-[900px] relative max-[1650px]:h-[800px] max-[1500px]:h-[700px] max-[1270px]:h-[650px]"
      ref={parent}
      id="heroSection"
    >
      <img
      ...
      <div
        dir="rtl"
        className="max-[1020px]:top-[170px] w-[650px] h-[400px] max-[1020px]:w-full max-[1350px]:scale-[85%] max-[1350px]:right-[50px] max-[1057px]:right-0 max-[1020px]:items-center max-[1280px]:mx-auto flex flex-col justify-evenly absolute right-[150px] top-[200px] max-[1270px]:top-[150px]"
      >
        <h1 className="z-10 text-[36px] text-[#666] mr-[45px] max-[1020px]:mr-0 dark:text-[#fff]">
          پژوهشگاه سپهر
        </h1>
        ...
        <button
          ref={btn}
          className="z-10 transition-all duration-500 bg-gradient-to-r max-[1020px]:mx-auto from-[#5A0BA9] to-[#C003B2] hover:bg-gradient-to-l rounded-[25px] w-[200px] h-[55px] whitespace-nowrap  text-[19px]  text-[#fff]"
