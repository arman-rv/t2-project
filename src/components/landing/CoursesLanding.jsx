  ...
  return (
    <div className="w-full relative max-[1600px]:flex-col">
      <div className="h-[250px] flex justify-center">
        <TitleComponents
          title="دوره ها"
          content="اخرین دوره های موجود"
          src="courses-title.png"
          className="flex mb-[45px]"
        />
      </div>
      ...
      <div className="max-[1250px]:w-[90%] max-[700px]:[&>div]:w-[95%] max-[820px]:[&>div]:w-[680px] max-[900px]:[&>div]:w-[800px] max-[900px]:[&>div]:mx-auto max-[1020px]:w-full max-[1020px]:flex-col-reverse max-[1020px]:items-center [&>div]:shadow-[0_0_7px_#ccc] dark:[&>div]:shadow-none  mx-auto [&>div]:mx-[30px] flex min-[1601px]:justify-center justify-center max-[1600px]:[&>div]:my-[15px]">
        <div className="[&>img:not(&>img:first-child):hover]:shadow-[0_0_25px_#999] bg-white dark:bg-gradient-to-br from-[#2e3a56] to-[#171f33] w-[350px] max-[820px]:h-[150px] h-[600px] rounded-[25px] flex flex-col max-[1020px]:flex-row justify-around items-center transition-all duration-100 relative max-[1020px]:h-[200px] max-[1020px]:w-[80%] max-[450px]:h-[105px]">
          <img
            src="/images/landingCourse/c-i-1.png"
            alt=""
          ...
          {item?.map((el, index) => {
            return (
              <img
                ...
                data-id={index++}
                data-courseid={el.courseId}
                onClick={(e) =>
                  landingCourseSelector(e, landingCourse?.current, setCourseId)
                }
              />
            );
          })}
          <Button
            content="بیشتر"
            link="/courses"
            className="mx-auto max-[1020px]:hidden"
          />
        </div>

        <div
          className="bg-white dark:bg-gradient-to-tl from-[#2e3a56] to-[#171f33] w-[650px] max-[400px]:h-[400px] max-[963px]:h-[250px] h-[600px] relative py-[15px] rounded-[25px] transition-all duration-150 max-[1020px]:w-[80%] max-[1020px]:flex max-[1020px]:flex-row-reverse max-[1020px]:h-[300px] max-[1020px]:items-center max-[650px]:h-[400px] max-[650px]:flex-col "
          data-courseid={item[1]?.courseId}
          ref={landingCourse}
        >
          <img
            src="/images/landingCourse/c-i-2.png"
            alt=""
            className="absolute right-[-100%] top-[0px] w-28 -z-10 transition-all duration-1000 max-[1020px]:hidden "
            id="coursesHolder2"
          />
          <img
            src={
