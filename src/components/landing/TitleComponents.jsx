...
const TitleComponents = ({ title, content, className }) => {
  ...
  const [imageSrc, setImageSrc] = useState(
    `/images/landingCourse/${theme}.png`
  );
  ...
  return (
    <div
      className={
        "w-[530px] max-[530px]:w-[410px]  max-[500px]:w-[380px] max-[400px]:w-[350px] max-[500px]:h-[185px]  h-[228px] relative mx-[auto] transition-all flex justify-center items-center   " +
        className
      }
    >
      ...
      <img
        src={imageSrc}
        alt=""
        className="img titleLand drop-shadow-[0px_3px_6px_#5757574f] w-full h-full absolute left-0 top-0"
      />
    </div>
  );
};
